...
//   OrderTable OT = new OrderTable();
   ...
   public OrderTable() {
      ...
      lblOrder = new JLabel("二쇰Ц");
      Font f1 = new Font("�룍��", Font.BOLD, 20);
      lblOrder.setFont(f1); 
      ...
      JLabel lblName = new JLabel("�씠由�");
      lblName.setBounds(69, 140, 69, 20);
      contentPane.add(lblName);
      
      JLabel lblAge = new JLabel("�굹�씠");
      lblAge.setBounds(69, 187, 69, 20);
      contentPane.add(lblAge);
      
      JLabel lblAddress = new JLabel("二쇱냼");
      lblAddress.setBounds(69, 234, 69, 20);
      contentPane.add(lblAddress);
      
      JLabel lblPhone = new JLabel("�쟾�솕踰덊샇");
      lblPhone.setBounds(69, 281, 69, 20);
      contentPane.add(lblPhone);
      
      
      JLabel lblGender = new JLabel("�꽦蹂�");
      ...
      BtnBack = new JButton("�씠�쟾");
      BtnBack.setBounds(49, 445, 139, 29);
      contentPane.add(BtnBack);
      
      BtnNext = new JButton("�떎�쓬");
